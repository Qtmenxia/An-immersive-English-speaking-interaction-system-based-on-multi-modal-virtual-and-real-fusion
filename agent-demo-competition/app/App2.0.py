...
teacher = AssistantAgent(
    ...
    system_message=(
        ...
        "You should only speak after the recorder, summarizing the user's language performance and suggesting improvements.\n"
        "Format your response as follows:"
        "First line: 'Start'"
        "Second line:'teacher"
        "Third line: Provide feedback on the user's language use (grammar, vocabulary, fluency, clarity, etc.) and Suggest specific improvements\n"
        "Last line: 'End'"
    ),
